	...
	<div class="w-[80vw] mx-auto text-pinjamin flex flex-col gap-2">
		<div class="p-3 md:p-6 flex flex-col gap-5">
			<div class="text-lg leading-6">
				<button class="text-gray-500 cursor-pointer focus:outline-none hover:underline"
					@click="$router.push('/spv-mobil')">
					Home
				</button>
				<span class="mx-2 text-gray-500">></span>
				<!-- Konfirmasi breadcrumb dengan @click dan tampilan tombol Tailwind -->
				<button class="text-gray-700 cursor-pointer focus:outline-none hover:underline"
